...
#if 1//def HTTPCLIENT_USING_SAMPLE
...
static int http_get_sample_task_func(int argc, char **argv)
{
    ...
    if (argc == 1)
    {
        ...
        if(URI == NULL)
        {
            printf("no memory for create URI buffer.\n");
            return OS_ERROR;
        }
    }
    else if (argc == 2)
    ...
    {
        printf("http_client_get_test [URI]  http client GET request test.\n");
        return OS_ERROR;
    }
    ...
    if( 0 <= ret ) 
    {
        ...
        printf("http_get_sample: Data received: %s\r\n",  buf);
    }
    else 
    {
        printf("http client get test failed and ret = %d errno=%d \n", ret, errno);
    }
...
static int http_post_sample_task_func(int argc, char **argv)
{
    ...
    {
        printf("http_client_post_test [URI]  - http client GET request test.\n");
        return OS_ERROR;
    }
    ...
    {
        printf("http client post test failed and ret=%d errno=%d \n", ret, errno);
    }
...
static int http_put_sample_task_func(int argc, char **argv)
{
    ...
    {
        printf("http_client_put_test [URI]  - http client PUT request test.\n");
        return OS_ERROR;
    }
    ...
    {
        printf("http client put test failed and ret=%d errno=%d \n", ret, errno);
    }
...
static int http_delete_sample_task_func(int argc, char **argv)
{
    ...
    {
        printf("http_client_delete_test [URI]  - http client DELETE request test.\n");
        return OS_ERROR;
    }
    ...
    {
        printf("http client delete test failed and ret = %d errno=%d \r\n", ret, errno);
    }
...
static int http_get_file_task_func(int argc, char **argv)
{
    ...
    else if (argc == 3)
    {
        ...
        if (URI == NULL)
        {
            printf("no memory for create FILE_NAME buffer.\n");
            return OS_ERROR;
        }
    }
